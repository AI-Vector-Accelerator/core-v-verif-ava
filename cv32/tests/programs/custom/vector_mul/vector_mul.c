...
int smul_test_e8_m1(uint8_t vlen) 
{
...
int smul_test_e8_m2(uint8_t vlen) 
{
...
int smul_test_e8_m4(uint8_t vlen) 
{
...
int wmulv_test_e8_m2(uint8_t vlen) 
{
...
int wmulv_test_e8_m4(uint8_t vlen) 
{
...
int wmulx_test_e8_m2(uint8_t vlen) 
{
...
int wmulx_test_e8_m4(uint8_t vlen) 
{
...
int smul_test_e16_m1(uint8_t vlen) 
{
...
int smul_test_e16_m2(uint8_t vlen) 
{
...
int smul_test_e16_m4(uint8_t vlen) 
{
...
int wmulv_test_e16_m1(uint8_t vlen) 
{
...
int wmulv_test_e16_m2(uint8_t vlen) 
{
...
int wmulv_test_e16_m4(uint8_t vlen) 
{
...
int wmulx_test_e16_m1(uint8_t vlen) 
{
...
int wmulx_test_e16_m2(uint8_t vlen) 
{
...
int wmulx_test_e16_m4(uint8_t vlen) 
{
...
int smul_test_e32_m1(uint8_t vlen) 
{
...
int smul_test_e32_m2(uint8_t vlen) 
{
...
int smul_test_e32_m4(uint8_t vlen) 
{
