...
{  
    ...
    if(result0 != 0 || result1 != -7 || result2 != -5 || result3 != 7)
    {
        printf("Fail: %d %d %d %d\n", result0, result1, result2, result3);
        return(1);
    }
...
int main(void)
{
    ...
    errors += sub_vx_test_e8_m2();
    errors += sub_vx_test_e8_m4();
    errors += sub_vx_test_e16_m1();
    errors += sub_vx_test_e16_m2();
    errors += sub_vx_test_e16_m4();
    errors += sub_vx_test_e32_m1();
    errors += sub_vx_test_e32_m2();
    errors += sub_vx_test_e32_m4();
